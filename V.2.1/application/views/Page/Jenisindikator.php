<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Jenis Indikator</li>
	</ol>
</section>
<section class="content">
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Data Jenis Indikator</h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
		<a class="btn btn-primary" href='#' onclick="add()">Tambah</a>
			<div class="table-responsive">
				<table id="tables" data-url="<?=base_url('Jenisindikator/get_tables')?>" class="table table-bordered table-striped" width="100%">
					<thead>
						<tr>
							<th>No</th>
							<th>NAMA JENIS INDIKATOR</th>
							<th></th>
						</tr>
					</thead>
					<tbody>
...
<div class="modal fade" id="modal-id">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="form_input" action="<?=base_url('Jenisindikator/save')?>">
              <div class="box-body">
			  ...
			  <input type="hidden" class="form-control" id="idJenisIndikator" name="idJenisIndikator">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="jenis" name="jenis" placeholder="JENIS INDIKATOR">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
