...
<section class="content">
	<div class="box box-success">
		...
		<div class="box-body">
			<div class="row">
				<form action="<?= base_url('Survei/Survei_Progres/' . $idKat) ?>/" method="POST" role="form">
	...
	<div class="box">
		...
		<div class="box-body">
			...
			<div class="table-responsive">
				<table id="tables1" data-url="<?= base_url('Survei/get_tables') ?>" class="table table-bordered table-striped" width="100%">
					<thead>
...
<div class="modal fade" id="modal-total">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header card-header-title text-center">
				<h4 class="modal-title card-element-title"></h4>
			</div>
			<div class="modal-body">

				<div class="table-responsive">
					<table class="table table-hover" id="variable_survei_total">
						<thead>
							<tr>
								<th>Indikator</th>
								<th>Nilai</th>
